...
const base =
  "type-button inline-flex items-center justify-center gap-2 rounded-full transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ivory-300 disabled:opacity-60 disabled:pointer-events-none";
